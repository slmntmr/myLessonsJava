...
public class ArrayList02 {
    public static void main(String[] args) {
        ...
        Collections.sort(nums);  //class ismiyle cagirilan methodlara statik method denir.2 yol
        //nums.sort(null); //List'lerde dogal siralama icin null gecilmesi gerekir. 1. yol
        ...
        //En kucuk farki hangi sayidan elde ettigimizi bulalim
