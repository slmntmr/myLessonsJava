...
public class Lambda03 {
    public static void main(String[] args) {
        ...
        System.out.println(getSumOfBeetweenTwoInteger(12, 5)); //24
    ...
    */
    ...
    public static int getMultiplicationFromThreeToNine2(){
        return IntStream.
                range(3, 10). //2.parametre dahil degil
                        reduce(Math::multiplyExact). //overflow
                        getAsInt();
    }
    ...
    public static int getSumOfBeetweenTwoInteger(int a, int b){
        //yer degistirme algoritmasi
        if (a > b){
            int temp = a; //temporary - gecici
            a = b;
            b = temp;
        }
