...
public class StringManipulations03 {
    public static void main(String[] args) {
        ...
        ==>Heap, dinamik olarak oluşturulan Objectler için kullanılır. Yani, new anahtar kelimesi ile
         oluşturduğunuz nesneler heap bölgesinde saklanır.
        ...
        ==>Non-primitive ya da referans türleri (örneğin, Object’ler ve diziler) heap belleğinde saklanır.
         Stack belleğinde sadece bu nesnelerin referansları (adresleri) saklanır. Java ve benzeri yüksek
         seviye diller, referansları-reference stack belleğinde ve asıl nesne verilerini heap belleğinde saklar.
         Bu yaklaşım, hem hızlı erişim hem de dinamik bellek yönetimi(basit-cunku heap karisik) arasında
         bir denge sağlar.*/
